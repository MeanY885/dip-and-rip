#!/usr/bin/env python3
"""
Clear Individual Trades and Trading Summary tables (non-interactive version).

This script safely clears the individual_trade and trading_record tables
without prompting for confirmation - suitable for Docker exec usage.

Usage:
    python clear_tables_force.py [database_path]
...
def main():
    ...
    if not os.path.exists(db_path):
        ...
        print("Usage: python clear_tables_force.py [database_path]")
        sys.exit(1)
    ...
    print("\n▶️  PROCEEDING AUTOMATICALLY (non-interactive mode)")
